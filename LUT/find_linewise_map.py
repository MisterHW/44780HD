...
if __name__ == "__main__":
	...
	mapimg = tiled_character_map([32,8], [6,9], [0,1,0,0]) 
	mapimg.tile_size = [5,8]
	mapimg.get_tile_pos_by_index = lambda idx, ts = mapimg.tile_count: [ idx % ts[0], (idx % (ts[0]*ts[1])) // ts[0] ] # assign tile organization function 
